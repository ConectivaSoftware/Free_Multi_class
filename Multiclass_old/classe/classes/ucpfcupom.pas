...
begin
   ...
   TThread.CreateAnonymousThread(procedure
      begin
         CPF := SA_PINPAD_CapturarCPF(frmcpfcupom.LConfigPinPad);
         SA_PINPAD_MostrarLogo(frmcpfcupom.LConfigPinPad);
...
begin
   if LConfigPinPad.PINPAD_Porta<>'' then
      begin
         ...
         edtcpf.Text       := SA_PINPAD_CapturarCPF(LConfigPinPad);
         lbdigitar.Caption := 'CPF ou CNPJ';
         Application.ProcessMessages;
         SA_PINPAD_MostrarLogo(LConfigPinPad);
         btok.Enabled      := true;
