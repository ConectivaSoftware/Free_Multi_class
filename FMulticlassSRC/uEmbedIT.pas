...
type
   ...
   TEmbedIT = class
      Private
         ...
         //---------------------------------------------------------------------
         LEmpresa    : TEmitente;              // Dados do emitente da NFCe do padrão ACBR
      ...
      Public
        ...
        //----------------------------------------------------------------------
         ...
         property Empresa                 : TEmitente               read LEmpresa                   write LEmpresa;              // Dados do emitente da NFCe do padrão ACBR                                                   // Para salvar no Banco de dados
         //---------------------------------------------------------------------
...
//   lib := TEmbedLib.Create('c:\temp\lib-embed-x86.dll');
   //---------------------------------------------------------------------------
   LSalvarLog            := true;
   lExecutando           := true;
   LTipoTEF              := EmbedTEF;
