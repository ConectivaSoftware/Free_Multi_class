...
type
  ...
  TEmitente = record
     ...
     xNome           : string;
     xFant           : string;
     EnderEmit       : TEnderEmitente;
     IE              : string;
  end;
  //----------------------------------------------------------------------------
  TKSConfigEmitente = record
     Emit            : TEmitente;              // Dados do emitente da NFCe do padrão ACBR
  end;
  //----------------------------------------------------------------------------
  ...
  TKSConfig = record // Configurações gerais para emissão da NFCe
     ...
     ConfigEmitente      : TEmitente;                      // Dados do emitente da NFCe do padrão ACBR
